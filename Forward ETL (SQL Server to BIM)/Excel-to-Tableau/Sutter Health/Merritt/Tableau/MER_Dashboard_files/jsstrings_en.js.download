...
(function(w) {
  var s = {
    ...
    AccessibilityCommandButtonInstruction: "{0} command button. Press the Space key to activate the command. Use arrow keys to navigate tooltip interactions. Press Escape to go back to the mark.",
