...
if __name__ == '__main__':
    ...
    csv_path = (r"C:\Users\jy492\OneDrive\Lenovo Desktop (new)\NucampFolder\Backend Python\
                GitHub Projects\Sutter ABSMC ETL Workflow\Forward ETL\SQLServer-to-Excel\ROOM_PER.csv")
    ...
    output.print_md("**[OK] ROOM_PER.csv successfully imported as unplaced rooms.**")